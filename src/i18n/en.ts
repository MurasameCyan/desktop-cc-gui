...
export const en: Messages = {
  ...
  chat: {
    ...
    planStatusDraft: "Drafting",
    planStatusAwaitingReview: "Awaiting review",
    planStatusSubmitting: "Submitting",
    planStatusApproved: "Approved",
    planStatusChangesRequested: "Changes requested",
    planStatusDeferred: "Deferred",
    planStatusCancelled: "Cancelled",
    planStatusExpired: "Expired",
    planStatusSuperseded: "Superseded",
    planReviewDefaultTitle: "Untitled plan",
    planReviewRevision: "Revision {{revision}}",
    planReviewCopy: "Copy raw plan",
    planReviewCopied: "Copied",
    planReviewViewFull: "View full plan",
    planReviewFullTitle: "Full plan preview",
    planReviewDraftHint: "Planning in progress — the text may keep updating…",
    planReviewDeferredHint:
      "Deferred: the plan is kept unapproved — use Resume review to decide later",
    planReviewResume: "Resume review",
    planReviewAwaitingHint:
      "Waiting for your review — actions are in the input area below",
    planReviewExecPermission: "Runs with permission: {{permission}}",
    planReviewApprove: "Approve & execute",
    planReviewRequestChanges: "Request changes",
    planReviewDefer: "Not now",
    planReviewFeedbackLabel: "Change request",
    planReviewFeedbackPlaceholder:
      "Describe what should change; the engine will replan…",
    planReviewFeedbackSubmit: "Send change request",
    planReviewCancel: "Cancel",
    planReviewSubmitting: "Submitting…",
    planReviewIncomplete: "Plan not complete yet — approval unavailable",
    planReviewConflict:
      "This plan was superseded by another window or a newer revision; the latest state is shown.",
    planReviewError:
      "Submit failed: {{message}}. The plan is still awaiting your decision.",
    planReviewGroupLabel: "Plan review actions",
    planReviewNotPending: "This plan is no longer awaiting review",
    planReviewDismiss: "Got it",
    planReviewFeedbackRequired: "Change feedback must not be empty",
