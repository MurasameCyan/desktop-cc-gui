...
export const en: Messages = {
  ...
  chat: {
    ...
    cliNativeDefault: "CLI native default",
    legacyChannel: "Existing host channel · {{name}}",
    engineUnavailable: "CLI is unavailable or disabled",
    engineLockedAfterStart: "This conversation has started; start a new conversation to use another CLI",
    providerUnavailable: "Provider is unavailable",
    selectedModelUnavailable: "The selected model is no longer available",
    engineSwitchInFlight: "The first request is preparing or running; CLI switching is temporarily unavailable",
    engineSelectionChanged: "The active conversation changed; reopen the model menu before choosing a CLI",
